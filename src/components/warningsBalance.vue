      ...
      <div class="table-wrapper">
        <div class="table-container" role="table" aria-label="Destinations">
          <div class="flex-table header" role="rowgroup">
            ...
            <div class="flex-row" role="columnheader">Price diference</div>
            <div class="flex-row" role="columnheader">Products price</div>
            <div class="flex-row" role="columnheader">Total</div>
            <div class="flex-row" role="columnheader">Cashier</div>
            <div class="flex-row" role="columnheader">Waiter</div>
          </div>
          <div class="flex-table row"
            ...
            <div class="flex-row" role="cell">{{order.prodPrices - order.total }} CLP</div>
            <div class="flex-row" role="cell">{{numberWithCommas(order.prodPrices)}} CLP</div>
            <div class="flex-row" role="cell">{{numberWithCommas(order.total)}} CLP</div>
            <div class="flex-row" role="cell">{{order.cashier}}</div>
            <div class="flex-row" role="cell">{{order.waiter}}</div>
          </div>
        </div>
      </div>
    </div>
